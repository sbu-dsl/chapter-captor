...
if __name__ == '__main__':
    ...
    df = pd.read_csv(training_data_loc, usecols=['para1_tokens', 'para2_tokens', 'label'])
    ...
    input_ids = pad_sequences(input_tokens, maxlen=300, dtype="long", value=0, truncating="pre", padding="post")
    seg_ids = pad_sequences(input_seg_ids, maxlen=300, dtype="long", value=1, truncating="pre", padding="post")
